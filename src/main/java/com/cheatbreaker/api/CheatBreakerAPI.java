...
public final class CheatBreakerAPI extends JavaPlugin implements Listener {
    ...
    private static final String MESSAGE_CHANNEL = "OldCB-Client";
    ...
    public void onEnable() {
        ...
        getCommand("ischeatbreakerbanned").setExecutor(new com.cheatbreaker.impl.CheckCheatBreakerBanned());
        getCommand("isrunningcheatbreaker").setExecutor(new com.cheatbreaker.impl.CheckRunningCheatBreaker());
